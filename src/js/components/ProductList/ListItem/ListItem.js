...
const ListItem = ({item, onCartClick, isInCart}) => {
  ...
  return (
    <div className="product-list-item">
      ...
      <div className="cart-image" onClick={(e) => onCartClick(item.id, e)}><span className='vertically-center' /><img alt='Cart' src={cartImage} /></div>
